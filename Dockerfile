...
RUN --mount=type=cache,target=/var/cache/apt \
    ...
    *) exit 1 ;; \
    ...
    && wget -qO- "https://github.com/Radarr/Radarr/releases/download/v${VERSION}/Radarr.master.${VERSION}.linux-core-${ARCH}.tar.gz" | \
...
FROM mcr.microsoft.com/dotnet/runtime-deps:7.0.4-cbl-mariner2.0-distroless
